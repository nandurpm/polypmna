        ...
        <div className="w-full px-4 sm:px-6 lg:px-10">
          ...
          <section className="relative pt-10 pb-8 sm:pt-14 sm:pb-10">
            ...
            <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.06 } } }} className="relative">
              ...
              {/* Stats */}
              <motion.div variants={fadeIn} className="mt-6 flex flex-wrap gap-4">
                {[
          ...
          <section className="pb-8">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ visible: { transition: { staggerChildren: 0.03 } } }}>
